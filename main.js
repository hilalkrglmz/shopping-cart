...
class Products {
    async getProducts() {
        try {
            let result = await fetch("https://652a233e55b137ddc83f52b2.mockapi.io/products");
...
class UI {
            ...
            <div class="col-lg-4 col-md-6">
                    <div class="product">
                        <div class="product-image">
                            <img src="${element.image}" alt="Product" class="img-fluid">
                        </div>
    ...
    getBagButtons() {
        const buttons = [...document.querySelectorAll(".btn-add-to-cart")]; //eğer doğrudan document.queryselectorAll yazsaydık nodelist dönerdi. Ama bize array lazım onun üzerinden döneceğiz. 
        buttonsDOM = buttons;
                ...
                <div class="cart-left-image">
                    <img src="${item.image}" alt="product" class="img-fluid">
                            ...
                            <div class="cart-left-info">
                                <a href="#" class="cart-left-info">${item.title}</a>
    ...
    getSingleButton(id){
        return buttonsDOM.find(button => button.dateset.id === id);
    }
}
...
class Storage {
    ...
    static getProduct(id) {
        let products = JSON.parse(localStorage.getItem("products"))//json dan parse et yani java scriptin kullanbileceği hale getir.
